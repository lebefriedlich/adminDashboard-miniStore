<body>
    ...
    <header class="navbar sticky-top bg-secondary flex-md-nowrap p-0 shadow" data-bs-theme="dark">
        <a class="navbar-brand col-md-3 col-lg-2 me-0 px-3 fs-6 text-white" href="<?= BASEURL; ?>">
            ...
            <div class="sidebar border border-right col-md-3 col-lg-2 p-0 bg-body-tertiary min-vh-100 position-fixed" style="top: 10;">
                <div class="offcanvas-md offcanvas-end bg-body-tertiary" tabindex="-1" id="sidebarMenu" aria-labelledby="sidebarMenuLabel">
                    <div class="offcanvas-body d-md-flex flex-column p-0 pt-lg-3 overflow-y-auto">
                        <h3 class="ms-3">Hai, <?= $_SESSION['user']['name_user'] ?></h3>
                        <ul class="nav flex-column">
                            <li class="nav-item">
                                <a class="nav-link d-flex align-items-center gap-2 text-black " href="<?= BASEURL; ?>">
                                    <svg class="bi">
                            ...
                            <li class="nav-item">
                                <a class="nav-link d-flex align-items-center gap-2 text-black" href="<?= BASEURL; ?>customers">
                                    <svg class="bi">
                            ...
                            <li class="nav-item">
                                <a class="nav-link d-flex align-items-center gap-2 text-black" href="<?= BASEURL; ?>admins">
                                    <svg class="bi">
                            ...
                            <li class="nav-item">
                                <a class="nav-link d-flex align-items-center gap-2 text-black" href="<?= BASEURL; ?>products">
                                    <svg class="bi">
                        ...
                        <ul class="nav flex-column mb-auto">
                            <li class="nav-item">
                                <a class="nav-link d-flex align-items-center gap-2 text-black" href="<?= BASEURL; ?>customers/logout">
                                    <svg class="bi">
                        ...
                        <tbody class="fs-6">
                            ...
                            foreach ($data['users'] as $user) : ?>
                                <tr>
                                    ...
                                    <td><?= $user['pass'] ?></td>
                                    <td>
                                        <a href="" class="text-decoration-none btn btn-primary btn-sm" data-bs-toggle="modal" data-bs-target="#EditModal<?= $user['id_user']; ?>">
                                            <svg class="bi">
                                                <use xlink:href="#edit"></use>
                                            </svg>
                                        </a>
                                        <a href="" class="text-decoration-none btn btn-danger btn-sm" data-bs-toggle="modal" data-bs-target="#deleteModal<?= $user['id_user']; ?>">
                                            <svg class="bi">
                                    ...
                                    <div class="modal-dialog">
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body">
                                                <form action="<?= BASEURL; ?>customers/edit" method="post">
                                                    <ul>
                                ...
                                <div class="modal fade" id="deleteModal<?= $user['id_user']; ?>" tabindex="-1" aria-labelledby="deleteModalLabel" aria-hidden="true">
                                    <div class="modal-dialog">
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-footer">
                                                <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Close</button>
                                                <a id="deleteLink" href="<?= BASEURL; ?>customers/delete/<?= $user['id_user']; ?>" class="btn btn-danger">Delete</a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
    ...
    <div class="modal fade" id="registerModal" tabindex="-1" aria-labelledby="registerModalLabel" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="<?= BASEURL; ?>customers/addUser" method="post">
